...
A címtárra vagy fájlra érvényes ACL-ek maximális száma 32 hozzáférési ACL-ek és 32 alapértelmezett ACL-ek. További információért lásd: [Hozzáférés-vezérlés az Azure Data Lake Storage Gen2-ben](/azure/storage/blobs/data-lake-storage-access-control).