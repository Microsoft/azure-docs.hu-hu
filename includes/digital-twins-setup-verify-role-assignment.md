...
Ezután tekintse meg az összes hozzárendelt szerepkört a *hozzáférés-vezérlés (iam) > szerepkör-hozzárendelések* területen. A felhasználónak az *Azure digitális Twins-adattulajdonosi* szerepkörrel kell megjelennie a listában. 
