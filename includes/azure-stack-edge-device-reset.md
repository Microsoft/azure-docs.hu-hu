...
2. Válassza az **eszköz alaphelyzetbe állítása** lehetőséget.
    ...
    ![Eszköz alaphelyzetbe állítása](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Ha a rendszer megerősítést kér, tekintse át a figyelmeztetést, és kattintson az **Igen** gombra a folytatáshoz.

    ![Alaphelyzetbe állítás megerősítése](media/azure-stack-edge-device-reset/device-reset-2.png)  
