...
ms.locfileid: "100551485"
---
Az NFS az **összes** 30 + régióban támogatott, ahol a Premium Files Storage elérhető.

Folyamatosan bővítjük a régiókat. A legfrissebb listához használja az alábbi mintát az NFS-támogatással rendelkező régiók listájának lekérdezéséhez. Az Azure-termékek területének támogatását is megkeresheti [régió oldalán](https://azure.microsoft.com/global-infrastructure/services/?products=storage&regions=all) , a **Premium Files Storage** alatt.
