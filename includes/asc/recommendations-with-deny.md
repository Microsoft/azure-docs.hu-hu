...
ms.locfileid: "103468008"
---
- A Storage-fiókok hozzáférése a tűzfalhoz és a virtuális hálózati konfigurációkhoz korlátozott tárolási fiókoknak kell korlátoznia a hálózati hozzáférést
- Az Automation-fiók változóit titkosítani kell a titkosított Automation-fiókok változóinak.
...
- Csak a biztonságos kapcsolatokat kell engedélyezni a Redis Cache csak a Redis Azure cache-hez való biztonságos kapcsolatait kell engedélyezni
...
- A Storage-fiókoknak való biztonságos átvitelnek engedélyezve kell lennie a biztonságos átvitelnek a Storage-fiókok számára.
- Service Fabric fürtökön a ClusterProtectionLevel tulajdonságot a EncryptAndSign Service Fabric-fürtökhöz kell beállítani, hogy a ClusterProtectionLevel tulajdonság értéke EncryptAndSign
- Service Fabric fürtöknek csak az ügyfél-hitelesítéshez Azure Active Directory kell használnia Service Fabric a fürtöknek csak az ügyfél-hitelesítéshez kell Azure Active Directory használniuk
...
- A Storage-fiókokat át kell telepíteni az új Azure Resource Manager erőforrásokra, a Storage-fiókokat át kell telepíteni az új Azure Resource Manager-erőforrásokra
...
- A virtuális gépeket át kell telepíteni az új Azure Resource Manager-erőforrások virtuális gépekre át kell telepíteni az új Azure Resource Manager-erőforrásokra
