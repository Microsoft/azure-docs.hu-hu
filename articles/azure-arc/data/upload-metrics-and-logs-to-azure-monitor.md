...
Egyszerű szolgáltatásnév létrehozásához frissítse az alábbi példát. Cserélje `<ServicePrincipalName>` le `SubscriptionId` `resourcegroup` az értékeket a értékre, és futtassa a parancsot:
