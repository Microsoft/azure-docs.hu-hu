...
* Az [Azure-folyamatok](/azure/devops/pipelines/get-started/what-is-azure-pipelines) használatával különböző architektúrák számára készíthet tároló-lemezképeket.
