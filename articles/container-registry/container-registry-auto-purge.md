...
* `--concurrency` -A párhuzamosan feldolgozandó törlési feladatok számát adja meg. Ha nincs megadva ez a paraméter, a rendszer az alapértelmezett értéket használja.
