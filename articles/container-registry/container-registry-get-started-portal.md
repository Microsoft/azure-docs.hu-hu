...
Az erőforrások megtisztítása érdekében keresse meg a **myResourceGroup** erőforráscsoportot a portálon. Az erőforráscsoport betöltése után kattintson  az Erőforráscsoport törlése elemre az erőforráscsoport, a tároló-beállításjegyzék és az ott tárolt tároló rendszerképének eltávolításához.
...
Ebben a rövid útmutatóban létrehozott egy Azure Container Registry a Azure Portal, leküldte a tároló rendszerképét, és lekérte és futtatta a rendszerképet a regisztrációs adatbázisból. Folytassa az Azure Container Registry oktatóanyagokkal az ACR mélyebb betekeredőbb leírásában.
