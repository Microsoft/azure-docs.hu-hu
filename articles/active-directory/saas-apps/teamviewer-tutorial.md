...
* A TeamViewer támogatja az **SP** által kezdeményezett egyszeri bejelentkezést.

## <a name="add-teamviewer-from-the-gallery"></a>TeamViewer hozzáadása a gyűjteményből
...
## <a name="configure-and-test-azure-ad-sso-for-teamviewer"></a>Az Azure AD SSO konfigurálása és tesztelése a TeamViewerhez
...
Az Azure AD SSO és a TeamViewer használatával történő konfigurálásához és teszteléséhez hajtsa végre a következő lépéseket:
...
1. A **[TEAMVIEWER SSO konfigurálása](#configure-teamviewer-sso)** – az egyszeri bejelentkezés beállításainak konfigurálása az alkalmazás oldalán.
    1. **[TeamViewer-tesztkörnyezet létrehozása](#create-teamviewer-test-user)** – a felhasználó Azure ad-beli képviseletéhez kapcsolódó B. Simon-partneri kapcsolattal rendelkezik.
...
1. A Azure Portal a **TeamViewer** alkalmazás-integráció lapon keresse meg a **kezelés** szakaszt, és válassza az **egyszeri bejelentkezés** lehetőséget.
...
* Kattintson az **alkalmazás tesztelése** Azure Portal lehetőségre. A rendszer átirányítja a TeamViewer bejelentkezési URL-címére, ahol elindíthatja a bejelentkezési folyamatot. 

* Lépjen közvetlenül a TeamViewer bejelentkezési URL-címére, és indítsa el innen a bejelentkezési folyamatot.

* Használhatja a Microsoft saját alkalmazásait. Amikor a saját alkalmazások TeamViewer csempére kattint, a rendszer átirányítja a TeamViewer bejelentkezési URL-címére. A saját alkalmazásokkal kapcsolatos további információkért lásd: [Bevezetés a saját alkalmazások](../user-help/my-apps-portal-end-user-access.md)használatába.
