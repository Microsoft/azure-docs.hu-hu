...
- [Felhasználói folyamatok](../../active-directory-b2c/tutorial-create-user-flows.md?pivots=b2c-user-flow)
- [Egyéni szabályzatok](../../active-directory-b2c/tutorial-create-user-flows.md?pivots=b2c-custom-policy)
