...
#### <a name="step-2-download-your-electron-project"></a>2. lépés: az Electron-projekt letöltése
...
> [!div renderon="docs"]
> #### <a name="step-3-configure-your-electron-project"></a>3. lépés: az Electron-projekt konfigurálása
>
