---
title: Akadémiai támogatásának kezelése az Azure Education-központ
description: Ismerteti, hogyan lehet megtekinteni és frissíteni a tanulmányi támogatás részleteit az Azure Education-központ – áttekintés oldalon.
author: v-shmck
ms.author: rymend
ms.topic: how-to
...
1. A **Labs** a tanulók számára átadott aktív laborok teljes számát jeleníti meg.
1. A **művelethez szükség** van a végrehajtandó összes műveletre, például a labor meghívásának elfogadására.
1. A **szoftver** felsorolja a pedagógusként letölthető ingyenes szoftvereket.
