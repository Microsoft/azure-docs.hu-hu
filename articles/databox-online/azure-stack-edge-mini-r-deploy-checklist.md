...
| Számítási hálózati beállítások     | <li>2 szabad, statikus, összefüggő IP-címeket igényel a Kubernetes-csomópontokhoz, és 1 statikus IP-címet IoT Edge szolgáltatáshoz.</li><li>1 további IP-címet igényel minden olyan extra szolgáltatáshoz vagy modulhoz, amelyet telepíteni fog.</li>| Csak a statikus IPv4-konfiguráció támogatott.|
