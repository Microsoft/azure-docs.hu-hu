...
1. Hozzon létre egy új rendelést a meglévő eszközhöz az [új erőforrás létrehozása](azure-stack-edge-gpu-deploy-prep?tabs=azure-portal#create-a-new-resource)című témakör lépéseit követve. A **szállítási címek** lapon válassza a **már van eszköz** elemet.
...
1. [Szerezze be az aktiválási kulcsot](azure-stack-edge-gpu-deploy-prep?tabs=azure-portal#get-the-activation-key).
...
1. [Aktiválja az eszközt](databox-online/azure-stack-edge-gpu-deploy-activate.md).
