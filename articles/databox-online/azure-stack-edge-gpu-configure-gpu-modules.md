...
2. Az **Áttekintés** területen válassza a **IoT Edge** lehetőséget.
    ...
    ![Modul konfigurálása a GPU 1 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-1.png)

3. A **IoT Edge szolgáltatás engedélyezése** lapon válassza a **Hozzáadás** lehetőséget.

   ![Modul konfigurálása a GPU 2 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-2.png)
...
4. A **IoT Edge szolgáltatás létrehozása** területen adja meg IoT hub erőforrásának beállításait:
   ...
   ![Ismerkedés a 2. számítási feladatokkal](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-3.png)
   ...
   ![Ismerkedés a 3. számítási feladatokkal](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-4.png)

5. A peremhálózati számítási szerepkör konfigurálásának megerősítéséhez válassza a **Tulajdonságok** lehetőséget.

   ![Ismerkedés a 4. számítási feladatokkal](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-5.png)

6. A **Tulajdonságok** területen válassza ki **IoT Edge eszköz** hivatkozását.

   ![Modul konfigurálása a GPU 6 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-2.png)
...
7. Válassza ki ezt az IoT Edge eszközt.
   ...
   ![Modul konfigurálása a GPU 7 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-3.png)

8. Válassza a **Set modules** (Modulok beállítása) lehetőséget.

   ![Modul konfigurálása a GPU 8 használatához](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-4.png)

9. Válassza a **+ Hozzáadás** , majd a **+ IoT Edge modul** lehetőséget. 

    ![Modul konfigurálása a GPU 9-es használatához](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-5.png)
...
10. A **IoT Edge modul hozzáadása** lapon:
    ...
    ![Modul konfigurálása a GPU 10 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-6.png)
...
11. A **környezeti változók** lapon adja meg a változó nevét és a hozzá tartozó értéket. 
    ...
    2. Állítsa az értéket 0 vagy 1 értékre. A 0 vagy az 1 érték biztosítja, hogy az eszköz legalább egy GPU-t használ ehhez a modulhoz. Ha az értéket 0, 1 értékre állítja, az azt jelenti, hogy az eszközön található GPU-k is ezt a modult használják.
       ...
       ![Modul konfigurálása a GPU 11 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-7.png)
...
12. Adja meg a modul nevét. Ezen a ponton dönthet úgy, hogy a tároló létrehozása lehetőséget adja meg, és módosítja a modul különálló beállításait, vagy ha elkészült, válassza a **Hozzáadás** lehetőséget. 
    ...
    ![Modul konfigurálása a GPU 12 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-8.png)

13. Győződjön meg arról, hogy a modul fut, és válassza a **felülvizsgálat + létrehozás** elemet.

    ![Modul konfigurálása a GPU 13 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-9.png)
...
14. A **felülvizsgálat + létrehozás** lapon megjelenik a kiválasztott központi telepítési beállítások. Tekintse át a beállításokat, és válassza a **Létrehozás** lehetőséget.
    ...
    ![Modul konfigurálása a GPU 14 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-10.png)

15. Jegyezze fel a modul **futtatókörnyezeti állapotát** .
    
    ![Modul konfigurálása a GPU 15 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-11.png)
    ...
    ![Modul konfigurálása a GPU 16 használatára](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-12.png)
