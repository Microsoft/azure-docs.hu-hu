...
A rendszer beszúr egy elemeket Azure Cosmos DBba, és az AZONOSÍTÓban [érvénytelen karakter](/dotnet/api/microsoft.azure.documents.resource.id#remarks) szerepel.
