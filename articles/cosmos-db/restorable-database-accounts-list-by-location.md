...
Az előfizetésben és egy régióban elérhető, visszaállítható Azure Cosmos DB adatbázis-fiókok listája. Ehhez a híváshoz `Microsoft.DocumentDB/locations/restorableDatabaseAccounts/read` engedély szükséges.
