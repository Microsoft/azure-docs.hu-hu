---
title: Helyreállítható adatbázis-fiókok listázása hely alapján Azure Cosmos DB REST API használatával
description: Az előfizetésben és egy régióban elérhető, visszaállítható Azure Cosmos DB adatbázis-fiókok listája.
author: kanshiG
...
ms.locfileid: "99537678"
---
# <a name="list-restorable-database-accounts-by-location-using-azure-cosmos-db-rest-api"></a>Helyreállítható adatbázis-fiókok listázása hely alapján Azure Cosmos DB REST API használatával
...
Felsorolja az előfizetésben és egy régióban elérhető, visszaállítható Azure Cosmos DB helyreállítható adatbázis-fiókokat. Ehhez a híváshoz `Microsoft.DocumentDB/locations/restorableDatabaseAccounts/read` engedély szükséges.
...
A List műveletre adott válasz, amely tartalmazza a helyreállítható adatbázis-fiókokat és azok tulajdonságait.
...
* A MongoDB Azure Cosmos DB API-ban lévő visszaállítható [gyűjtemények listázása](restorable-database-accounts-list-by-location.md) REST API használatával.
