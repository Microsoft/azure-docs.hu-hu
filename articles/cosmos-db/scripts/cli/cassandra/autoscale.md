---
title: Cassandra-kulcstér és -tábla létrehozása automatikus skálázással a Azure Cosmos DB
description: Cassandra-kulcstér és -tábla létrehozása automatikus skálázással a Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107786843"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-with-autoscale-using-azure-cli"></a>Azure Cosmos-Cassandra API, kulcstér és tábla létrehozása automatikus skálázással az Azure CLI használatával
