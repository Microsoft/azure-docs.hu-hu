...
description: Ez a cikk egy Azure CLI-példaszk szkriptet mutat be, amely bemutatja, hogyan iratkhat fel Azure Event Grid egy erőforráscsoporthoz az egyes eseményekre.
ms.devlang: azurecli
ms.topic: sample
ms.date: 07/08/2020
