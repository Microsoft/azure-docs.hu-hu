...
A Azure Event Grid egy teljes körűen felügyelt esemény-útválasztási szolgáltatás, amely egy közzétételi és előfizetési modellt használ. A Event Grid beépített támogatást nyújt az Azure-szolgáltatások, például a [Azure functions](../azure-functions/functions-overview.md) és a [Azure Logic apps](../azure-functions/functions-overview.md)számára. A webhookok használatával az események riasztásait nem Azure-szolgáltatásokhoz is kézbesítheti. A Event Grid által támogatott eseménykezelők teljes listájáért tekintse [meg a Azure Event Grid bemutatása](overview.md)című témakört.
...
> [!NOTE]
> Ha többet szeretne megtudni arról, hogy az adattárolás hogyan kapcsolódik az események kezeléséhez, látogasson el az [adatrezidens fogalmi dokumentációra](../communication-services/concepts/privacy.md) .
...
| Microsoft. Communication. ChatParticipantAddedToThreadWithUser|  A felhasználó számára közzé kell tenni, ha új résztvevőt vesznek fel egy csevegési szálba, és a felhasználó a tagja.|
| Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser |  A felhasználó számára közzé kell tenni, ha egy résztvevőt eltávolítanak egy csevegési szálból, és a felhasználó a részét képezi. |
| Microsoft. Communication. ChatThreadCreated  | Közzététel csevegési szál létrehozásakor  |
| Microsoft. Communication. ChatThreadDeleted| Közzététel csevegési szál törlésekor  |
| Microsoft. Communication. ChatThreadParticipantAdded | Közzététel új résztvevő csevegési szálba való felvételekor  |
| Microsoft. Communication. ChatThreadParticipantRemoved | Közzétételre kerül, ha új résztvevőt adnak hozzá egy csevegési szálhoz.  |  
| Microsoft. Communication. ChatMessageReceivedInThread | Közzététel, ha üzenet érkezik egy csevegési szálba  |    
| Microsoft. Communication. ChatThreadPropertiesUpdated| Közzététel, ha a csevegési szál tulajdonságai (például a témakör) frissülnek.|    
| Microsoft. Communication. ChatMessageEditedInThread | Közzététel üzenet egy csevegési szálban való szerkesztésekor |  
| Microsoft. Communication. ChatMessageDeletedInThread | Közzététel üzenet egy csevegési szálban való törlésekor  |  

A Azure Portal vagy az Azure CLI segítségével előfizethet a kommunikációs szolgáltatások erőforrásai által kibocsátott eseményekre. Ismerkedés az események kezelésével a [kommunikációs szolgáltatásokban lévő SMS-események](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) kezelésének megvizsgálása révén
...
### <a name="microsoftcommunicationchatparticipantaddedtothreadwithuser--event"></a>Microsoft. Communication. ChatParticipantAddedToThreadWithUser esemény 
```json
[{
...
### <a name="microsoftcommunicationchatparticipantremovedfromthreadwithuser-event"></a>Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser esemény 
```json
[{
...
### <a name="microsoftcommunicationchatthreadcreated-event"></a>Microsoft. Communication. ChatThreadCreated esemény
...
```
### <a name="microsoftcommunicationchatthreadpropertiesupdated-event"></a>Microsoft. Communication. ChatThreadPropertiesUpdated esemény
...
```
### <a name="microsoftcommunicationchatthreaddeleted-event"></a>Microsoft. Communication. ChatThreadDeleted esemény
...
```
### <a name="microsoftcommunicationchatthreadparticipantadded-event"></a>Microsoft. Communication. ChatThreadParticipantAdded esemény
...
```
### <a name="microsoftcommunicationchatthreadparticipantremoved-event"></a>Microsoft. Communication. ChatThreadParticipantRemoved esemény
...
```
### <a name="microsoftcommunicationchatmessagereceivedinthread-event"></a>Microsoft. Communication. ChatMessageReceivedInThread esemény
...
```
### <a name="microsoftcommunicationchatmessageeditedinthread-event"></a>Microsoft. Communication. ChatMessageEditedInThread esemény
...
### <a name="microsoftcommunicationchatmessagedeletedinthread-event"></a>Microsoft. Communication. ChatMessageDeletedInThread esemény
...
| Cím | Leírás |
| --- | --- |
| [Az SMS-események kezelése a kommunikációs szolgáltatásokban](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | A kommunikációs szolgáltatás által a webhook használatával fogadott összes SMS-esemény kezelését. |
