...
Az alábbi példa [Windows-események](../agents/data-sources-windows-events.md) gyűjteményét adja hozzá egy meglévő munkaterülethez.
...
A következő minta a syslog- [események](../agents/data-sources-syslog.md) gyűjteményét adja hozzá egy meglévő munkaterülethez.
...
Az alábbi példa egy meglévő munkaterülethez hozzáadja a [Windows](../agents/data-sources-performance-counters.md) -teljesítményszámlálók gyűjteményét.
...
Az alábbi példa egy meglévő munkaterülethez tartozó [Linux](../agents/data-sources-performance-counters.md) -teljesítményszámlálók gyűjteményét adja hozzá.
...
Az alábbi minta [egyéni naplók](../agents/data-sources-custom-logs.md) gyűjteményét adja hozzá egy meglévő munkaterülethez.
...
Az alábbi minta egy meglévő munkaterülethez hozzáadja az [IIS-naplók](../agents/data-sources-iis-logs.md) gyűjteményét.
