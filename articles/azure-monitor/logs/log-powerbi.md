...
:::image type="content" source="media/log-powerbi/export-query2.png" alt-text="Az exportálási lehetőség legördülő menüjét megjelenítő Log Analytics lekérdezés" border="true":::
