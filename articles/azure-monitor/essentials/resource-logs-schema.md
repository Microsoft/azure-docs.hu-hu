...
| Azure Adatkezelő | [Azure Adatkezelő-naplók](/azure/data-explorer/using-diagnostic-logs) |
...
| Kubernetes Service |[Azure Kubernetes-naplózás](../../aks/view-control-plane-logs.md#log-event-schema) |
