...
A tárolókhoz készült Azure Monitor ügynökpodjai a csomóponti ügynök cAdvisor-végpontját használják a teljesítménymetrikák gyűjtéséhez. Ellenőrizze, hogy a csomóponton lévő tároló ügynök úgy van-e konfigurálva, hogy `cAdvisor port: 10255` a teljesítmény-metrikák gyűjtéséhez a fürt összes csomópontján meg lehessen nyitni.
