...
1. **Ellenőrizte a műveleti szabály paramétereit?**  
    ...
    Győződjön meg a [műveleti szabály dokumentációjában](../alerts/alerts-action-rules.md)vagy a [műveleti szabály PowerShell set-AzActionRule](/powershell/module/az.alertsmanagement/set-azactionrule) parancsának megtekintéséhez. 
