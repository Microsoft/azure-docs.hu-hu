...
Az alábbi minta [számos találati riasztási szabályt](../alerts/alerts-unified-log.md#count-of-the-results-table-rows)hoz létre.

### <a name="notes"></a>Jegyzetek

- Ez a minta egy [webhook-adattartalmat](../alerts/alerts-log-webhook.md)tartalmaz. Ha a riasztási szabály nem indít el webhookot, távolítsa el a **customWebhookPayload** elemet.
...
Az alábbi minta egy [metrikai mérési riasztási szabályt](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)hoz létre.
