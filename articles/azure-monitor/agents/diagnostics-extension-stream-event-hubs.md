...
| Tulajdonság | Leírás |
|:---|:---|
| Név | A fogadó leíró neve. A konfigurációban a fogadóba küldendő adatforrások megadására szolgál. |
...
* [Event Hubs – gyakori kérdések](../../event-hubs/event-hubs-faq.yml)
