...
1. Konfigurálja a Azure Diagnostics bővítményt a Profiler engedélyezéséhez:
    ...
    a. Keresse meg az alkalmazás szerepköréhez tartozó [Azure Diagnostics](../agents/diagnostics-extension-overview.md) *Diagnostics. wadcfgx* fájlt, ahogy az itt látható:  
