...
| `OnClick`              | `(double lat, double lon): boolean` | A Térkép megnyomásakor és a térképen való kikapcsolásakor a rendszer kilőtte a térképet. Ez az eseménykezelő egy logikai értéket ad vissza, amely azt jelzi, hogy az eseményt fel kell-e használni, vagy más esemény-figyelőknek kell átadni. |
| `OnFeatureClick`       | `(List<Feature>): boolean`    | A rendszer a Térkép megnyomásakor és a Szolgáltatáson megjelenő pontokon való kiadása után felgyújtotta. Ez az eseménykezelő egy logikai értéket ad vissza, amely azt jelzi, hogy az eseményt fel kell-e használni, vagy más esemény-figyelőknek kell átadni. |
...
| `OnLongClick`          | `(double lat, double lon): boolean` | A Térkép lenyomásakor, egy pillanatra, majd a térképen megjelenő ponton jelenik meg. Ez az eseménykezelő egy logikai értéket ad vissza, amely azt jelzi, hogy az eseményt fel kell-e használni, vagy más esemény-figyelőknek kell átadni. |
| `OnLongFeatureClick `  | `(List<Feature>): boolean`    | A rendszer a Térkép lenyomásakor, egy pillanatra, majd a szolgáltatás ugyanazon pontján jelenik meg. Ez az eseménykezelő egy logikai értéket ad vissza, amely azt jelzi, hogy az eseményt fel kell-e használni, vagy más esemény-figyelőknek kell átadni. |
