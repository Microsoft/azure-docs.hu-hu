...
A Azure Maps Android SDK olyan osztályt biztosít, amely megkönnyíti a `Popup` térképen való elhelyezésre rögzített felhasználói felületi megjegyzések létrehozását. Az előugró ablakok esetében egy relatív elrendezéssel rendelkező nézetet kell átadni a `content` felugró ablakhoz. Íme egy egyszerű elrendezési példa, amely a háttérben a sötét szöveget jeleníti meg.
