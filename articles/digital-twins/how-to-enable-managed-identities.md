---
title: Felügyelt identitás engedélyezése útválasztási eseményekhez (előzetes verzió)
titleSuffix: Azure Digital Twins
description: Megtudhatja, hogyan engedélyezheti a rendszer által hozzárendelt identitást az Azure digitális ikrek számára, és hogyan használhatja azokat az események továbbítására.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948784"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Felügyelt identitás engedélyezése az Azure Digital Twins-események útválasztásához (előzetes verzió)
...
Ebben a szakaszban a [Azure Portal](https://portal.azure.com) segítségével egy rendszerfelügyelt identitást adhat hozzá egy olyan Azure digitális Twins-példányhoz, amely már létezik.
