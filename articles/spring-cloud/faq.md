...
Igen. További információ: [oktatóanyag: elosztott nyomkövetés használata az Azure Spring Cloud használatával](spring-cloud-howto-distributed-tracing.md).
