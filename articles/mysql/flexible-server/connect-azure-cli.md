...
További argumentumokat is megadhat ennek a parancsnak a testreszabásához. Az [az MySQL flexibilis-Server Create](/cli/azure/mysql/flexible-server?view=azure-cli-latest#az_mysql_flexible_server_create)összes argumentumának megjelenítése.
