...
| [`az webapp deployment source config`](/cli/azure/webapp/deployment/source#az-webapp-deployment-source-config) | Társít egy App Service egy Git- vagy Mercurial-adattárhoz. |
