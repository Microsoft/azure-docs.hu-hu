...
<li><a href="/cli/azure/webapp#az-webapp-create">Hozzon létre egy <abbr title="A webalkalmazás ábrázolása, amely az alkalmazás kódját, DNS-állomásnevét, tanúsítványait és kapcsolódó erőforrásait tartalmazza. "> App Service alkalmazás</abbr></a> a megadott névvel.</li>
</ul>
</details>
