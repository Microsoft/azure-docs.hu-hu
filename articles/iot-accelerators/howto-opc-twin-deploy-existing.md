...
* Ha a bérlők listájából választ egy HRE-bérlőt, indítsa újra a szkriptet, és válasszon egy másikat a listából.
* Másik megoldásként helyezzen üzembe egy privát HRE-bérlőt egy másik előfizetésben, indítsa újra a szkriptet, és válassza ki a használatát.
