...
Keresse meg a minta projektjét a [githubon](https://github.com/Azure-Samples/communication-services-android-calling-hero). A minta [csapatokkal való együttműködéssel](../../concepts/teams-interop.md) rendelkező verziója különálló [ágban](https://github.com/Azure-Samples/communication-services-android-calling-hero/tree/feature/teams_interop)található.
