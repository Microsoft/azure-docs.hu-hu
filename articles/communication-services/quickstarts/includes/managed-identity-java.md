...
Részletesebben is tájékozódhat arról, hogyan működik a DefaultAzureCredential objektum, és hogyan használhatja azt olyan módon, amely nincs megadva ebben a rövid útmutatóban: [Azure Identity Client Library for Java](https://docs.microsoft.com/java/api/overview/azure/identity-readme)
