...
A privát végpontok PowerShellben való létrehozásával kapcsolatos további információkért tekintse meg ezt a [privát hivatkozás](../private-link/create-private-endpoint-cli.md) rövid útmutatóját.
