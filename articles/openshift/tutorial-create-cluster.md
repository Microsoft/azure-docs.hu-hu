...
Az ARO-lekérési titok nem változtatja meg az ARO-hoz tartozó RH OpenShift-licenc költségeit.
...
1. Az erőforrás-szolgáltató regisztrálása `Microsoft.Authorization` :
