---
title: Big-és elemzési partnerek
titleSuffix: Azure Storage
description: Azoknak a Microsoft-partnereknek a listája, amelyek az Azure Storage-ban big data és elemzésre szolgáló felhasználói megoldásokat építenek
author: beber-msft
ms.author: beber
ms.date: 03/15/2021
ms.topic: conceptual
...
Ez a cikk a Azure Data Lake Storage integrált Microsoft-partneri vállalatait mutatja be. Ezek a partneri megoldások olyan számítási feladatokat foglalnak magukban, mint a modern adattárház számítási feladatai, a fejlett Analitika és a valós idejű elemzések. Ezek a partnerek kihasználhatják az Azure Storage [hierarchikus névterét](../../../blobs/data-lake-storage-namespace.md) a megoldás optimalizálásához és az Azure-ban való hatékony futtatásához.
