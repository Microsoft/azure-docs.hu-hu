...
2. Telepítse a legújabb az vagy AzureRM modult a dokumentációt követve:
    - [Az Module (.NET 4.7.2 szükséges)](/powershell/azure/install-az-ps)
...
> [!Warning]  
> Ha egy felhőalapú végpont által jelenleg használt Azure-fájlmegosztás metaadatait törli, Azure File Sync művelet sikertelen lesz. Ha ezt a fájlmegosztást egy másik szinkronizálási csoportban használja a szinkronizálásra, akkor a régi szinkronizálási csoportban lévő fájlok adatvesztése szinte biztos.
