...
description: Ez a cikk az azcopy jobs clean parancs referenciainformációit biztosítja.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
...
ms.locfileid: "107503422"
---
# <a name="azcopy-jobs-clean"></a>azcopy jobs clean

Az összes feladathoz szükséges összes napló- és tervfájl eltávolítása
...
**--help**                Segítség a tisztításhoz.

**--with-status** sztring Csak az ezzel az állapottal (elérhető értékek) állapotú feladatokat távolítja el: `Canceled` , , , , `Completed` `Failed` `InProgress` `All` (alapértelmezett `All` )
...
**--output-type** string A parancs kimenetének formátuma. A lehetőségek a következők: szöveg, json. Az alapértelmezett érték a "text". (alapértelmezett "szöveg")
