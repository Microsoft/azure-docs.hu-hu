...
description: Ez a cikk az azcopy make parancs referenciainformációit biztosítja.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
...
|Beállítás|Leírás|
|--|--|
|-h, --help|Súgótartalom megjelenítése a make parancshoz. |
|--quota-gb uint32|A megosztás maximális méretét határozza meg gigabájtban (GB), a nulla azt jelenti, hogy elfogadja a fájlszolgáltatás alapértelmezett kvótáját.|
