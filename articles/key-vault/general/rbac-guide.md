...
A fenti szerepkör-hozzárendelés lehetővé teszi a Key Vault-objektumok felsorolását a Key Vaultban.
...
3. Hozzon létre egy "Key Vault titkoskulcs-felelős" szerepkört az aktuális felhasználó számára.
...
A fenti szerepkör-hozzárendelés létrehozása után titkos kulcsok hozhatók létre,frissítve/törölhetők.
