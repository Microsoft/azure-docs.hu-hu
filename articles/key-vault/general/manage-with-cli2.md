...
Az [az keyvault update parancs használatával](/cli/azure/keyvault#az_keyvault_update) engedélyezheti a speciális szabályzatokat a kulcstartóhoz.
