...
A Key Vault Azure Monitor a naplók és a metrikák összeadásával globális figyelési megoldást biztosít. [További információ a Key Vault Azure Monitorről](https://docs.microsoft.com/azure/azure-monitor/insights/key-vault-insights-overview#introduction-to-azure-monitor-for-key-vault)
