---
title: Azure Policy megfelelőségi vezérlők a Azure Key Vault
description: A Azure Policy megfelelőségi vezérlők listáját Azure Key Vault. Ezek a beépített szabályzatdefiníciók gyakori megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 04/21/2021
ms.topic: sample
author: msmbaldwin
ms.author: mbaldwin
