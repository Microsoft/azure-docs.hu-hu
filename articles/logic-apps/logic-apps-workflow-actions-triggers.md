...
Az alábbi szempontokat érdemes áttekinteni, mielőtt engedélyezte a párhuzamosságot egy triggeren:
...
A mögöttes trigger definíciójában adja hozzá a `runtimeConfiguration.concurrency.runs` tulajdonságot, és állítsa be az értéket az [trigger egyidejűségi korlátai](logic-apps-limits-and-config.md#concurrency-debatching)alapján. A munkafolyamat szekvenciális futtatásához állítsa a tulajdonság értékét a következőre: `1` .
