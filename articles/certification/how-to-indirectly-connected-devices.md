...
ms.locfileid: "105969295"
---
# <a name="device-bundles-and-indirectly-connected-devices"></a>Eszköz-kötegek és közvetve csatlakoztatott eszközök

Az Azure-ban egy eszközön, SaaS-n vagy Pástin keresztül kommunikáló eszközök támogatásához a beküldési portál ( https://www.certify.azure.com) és az eszköz katalógusa) (a csomagban lévő és az eszközökhöz kapcsolódó https://devicecatalog.azure.com) függőségek is lehetővé teszik, hogy az eszközök kombinációi hozzáférhessenek az Azure Certified eszköz programhoz.
