---
title: Azure Policy szabályozási megfelelőségi szabályozása Azure Machine Learning
description: Felsorolja Azure Policy Azure Machine Learning számára elérhető szabályozási megfelelőségi szabályozásokat. Ezek a beépített szabályzat-definíciók közös megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 02/09/2021
ms.topic: sample
author: BlackMist
ms.author: larryfr
