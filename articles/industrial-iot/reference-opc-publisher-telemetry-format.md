---
title: Microsoft OPC-közzétevő telemetria formátuma
description: Ez a cikk áttekintést nyújt a konfigurációs beállítások fájljáról.
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787552"
---
# <a name="opc-publisher-telemetry-format"></a>OPC-közzétevő telemetria formátuma

Az OPC közzétevő 2,6-es és újabb verziója támogatja a standard OPC UA-közzététel JSON-formátumot [az OPC ua-specifikáció 14. részében](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) megadott módon, és így néz ki:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Emellett az OPC-közzétevő összes verziója támogatja a nem szabványosított, egyszerű JSON-telemetria formátumot, amely kompatibilis a [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) és a következőképpen néz ki:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>OPC-közzétevő telemetria konfigurációs fájlformátuma
```
