---
title: Azure Policy megfelelőségi vezérlők az Azure hálózati szolgáltatásaihoz
description: Felsorolja Azure Policy Azure hálózati szolgáltatásokhoz elérhető szabályozási megfelelőségi vezérlőket. Ezek a beépített szabályzatdefiníciók gyakori megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 04/21/2021
ms.topic: sample
author: KumudD
ms.author: kumud
