---
title: Beépített szabályzatdefiníciók az Azure hálózati szolgáltatásaihoz
description: Felsorolja Azure Policy Azure hálózati szolgáltatások beépített szabályzatdefinícióit. Ezek a beépített szabályzatdefiníciók gyakori megközelítéseket biztosítanak az Azure-erőforrások kezeléséhez.
ms.date: 04/14/2021
ms.topic: reference
author: KumudD
ms.author: kumud
