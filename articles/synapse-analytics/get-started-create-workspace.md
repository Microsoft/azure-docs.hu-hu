...
3. Az **alapbeállítások** lap **projekt részletei** területén adja meg a következő mezőket:
...
4. Az **alapok** lap **munkaterület részletei** területén adja meg a következő mezőket:
