...
* [sys.pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?view=azure-sqldw-latest&preserve-view=true) (előzetes verzió)
* [sys.pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?view=azure-sqldw-latest&preserve-view=true) (előzetes verzió)
* [sys.pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?view=azure-sqldw-latest&preserve-view=true) (előzetes verzió)
...
* [sys.workload_management_workload_classifier_details](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifier-details-transact-sql?view=azure-sqldw-latest&preserve-view=true) (előzetes verzió)
* [sys.workload_management_workload_classifiers](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifiers-transact-sql?view=azure-sqldw-latest&preserve-view=true) (előzetes verzió)
...
* [sys. szerelvények](/sql/relational-databases/system-catalog-views/sys-assemblies-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. tanúsítványok](/sql/relational-databases/system-catalog-views/sys-certificates-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. hitelesítő adatok](/sql/relational-databases/system-catalog-views/sys-credentials-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. fájlcsoportok](/sql/relational-databases/system-catalog-views/sys-filegroups-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. indexek](/sql/relational-databases/system-catalog-views/sys-indexes-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. eljárások](/sql/relational-databases/system-catalog-views/sys-procedures-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. szinonimák](/sql/relational-databases/system-catalog-views/sys-synonyms-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.syskarakterkészletek](/sql/relational-databases/system-compatibility-views/sys-syscharsets-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [ Oszlopoksys.sys](/sql/relational-databases/system-compatibility-views/sys-syscolumns-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [ Adatbázisoksys.sys](/sql/relational-databases/system-compatibility-views/sys-sysdatabases-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.sysnyelvek](/sql/relational-databases/system-compatibility-views/sys-syslanguages-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [ Objektumoksys.sys](/sql/relational-databases/system-compatibility-views/sys-sysobjects-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.sysreferenciák](/sql/relational-databases/system-compatibility-views/sys-sysreferences-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys.systípusok](/sql/relational-databases/system-compatibility-views/sys-systypes-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [ Felhasználóksys.sys](/sql/relational-databases/system-compatibility-views/sys-sysusers-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [OSZLOPOK](/sql/relational-databases/system-information-schema-views/columns-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [PARAMÉTEREK](/sql/relational-databases/system-information-schema-views/parameters-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [RUTINOK](/sql/relational-databases/system-information-schema-views/routines-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [SÉMÁK](/sql/relational-databases/system-information-schema-views/schemata-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [TÁBLÁK](/sql/relational-databases/system-information-schema-views/tables-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [KILÁTÁSSAL](/sql/relational-databases/system-information-schema-views/views-transact-sql?view=azure-sqldw-latest&preserve-view=true)
