...
Az elkülönítési szintekkel és a tranzakciós korlátokkal kapcsolatos további tudnivalókért tekintse meg a [DEDIKÁLT SQL-készlet tranzakciói](develop-transactions.md) című témakört.  Az egyéb ajánlott eljárások áttekintését lásd: [DEDIKÁLT SQL Pool](best-practices-dedicated-sql-pool.md)– ajánlott eljárások.
