...
description: A Spark, a Scala, a Python és a .NET támogatott verziói
...
Spark-kaptár-thriftserver_2.11-2.4.4.2.6.99.201 -25973884. jar
...
szinapszis – Spark-telemetry_2.11-0.0.1. jar
...
hitelesítésszolgáltató – tanúsítványok = = 2020.6.20
...
azureml-adatelőkészítés = = 2.3.1

azureml-adatelőkészítés-Native = = 23.0.0


azureml-adatelőkészítés-rslex = = 1.1.1

azureml – adatkészlet – futtatókörnyezet = = 1.16.0

azureml – alapértékek = = 1.16.0

azureml – értelmezés = = 1.16.0
...
azureml – folyamat = = 1.16.0

azureml – folyamat – mag = = 1.16.0
...
importlib – metaadatok = = 1.7.0

értelmezés – Közösség = = 0.15.1

értelmezés – mag = = 0.2.1
...
Prometheus-lombik-exportőr = = 0.18.1
...
táblázatban összegezheti = = 0.8.7

TB-éjjel = = 1.14.0

tensorboard = = 2.3.0

tensorboard-beépülő modul – szellemesség = = 1.7.0

tensorflow = = 2.0.0 B1

tensorflow-kalkulátor = = 2.3.0

termcolor = = 1.1.0

textblob = = 0.15.3

TF-kalkulátor-Night-= = 1.14.0
...
begépelés – kiterjesztések = = 3.7.4.3
