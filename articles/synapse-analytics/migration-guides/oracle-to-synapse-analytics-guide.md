---
title: 'Oracle – Azure szinapszis Analytics: áttelepítési útmutató'
description: A következő szakaszokban áttekintheti, hogy mi a teendő egy meglévő Oracle Database-megoldás Azure szinapszis Analytics szolgáltatásba való áttelepítésével kapcsolatban.
...
ms.locfileid: "103419201"
---
# <a name="migration-guide-migrate-oracle-data-warehouse-to-a-dedicated-sql-pool-in-azure-synapse-analytics"></a>Áttelepítési útmutató: Oracle-adattárház áttelepítése dedikált SQL-készletre az Azure szinapszis Analyticsben
A következő szakaszokban áttekintheti, hogy mi a teendő egy meglévő Oracle-adattárház megoldás Azure szinapszis Analytics szolgáltatásba való áttelepítésével kapcsolatban.
...
- SSMA az Oracle-objektumok SQL Serverba konvertálásához. További információkért lásd: [Oracle-adatbázisok áttelepítése SQL Serverra (OracleToSQL)](https://docs.microsoft.com/sql/ssma/oracle/migrating-oracle-databases-to-sql-server-oracletosql) . 
