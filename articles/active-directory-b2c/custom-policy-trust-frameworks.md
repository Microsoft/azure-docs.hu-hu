...
1. Adja hozzá a szükséges [házirend-kulcsokat](custom-policy-get-started.md#add-signing-and-encryption-keys) , és [regisztrálja az Identity Experience Framework-alkalmazásokat](custom-policy-get-started.md#register-identity-experience-framework-applications).
