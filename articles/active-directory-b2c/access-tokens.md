...
- `<application-ID-URI>` – Az ügyfélalkalmazások API-paneljének **közzététele** alatt beállított alkalmazásspecifikus URI-azonosító.
- `<scope-name>` – Az ügyfélalkalmazás API-paneljének **közzététele** alatt hozzáadott hatókör neve.
