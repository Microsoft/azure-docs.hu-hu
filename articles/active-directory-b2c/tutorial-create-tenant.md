...
1. Tekintse át a címtár beállításait. Ezután kattintson a **Létrehozás** elemre. [Telepítési hibák elhárítása](../azure-resource-manager/templates/common-deployment-errors.md).
