...
Töltse fel és dolgozza fel a tartalmat az [Azure Portalban található eszközök kezelése](asset-create-asset-upload-portal-quickstart.md) című témakörben leírtak szerint
...
![Tartalmi kulcsokra vonatkozó szabályzat létrehozása](./media/drm-encrypt-content-how-to/create-content-key-policy.png)

Akár a DRM-beállítások valamelyikét, akár egy AES-128 Clear Key beállítást választ, javasoljuk, hogy adja meg, hogyan szeretné konfigurálni a korlátozásokat. Dönthet úgy, hogy nyitott vagy jogkivonat-korlátozást használ. Részletes magyarázatot a [tartalom-hozzáférés szabályozása](drm-content-protection-concept.md#controlling-content-access)című témakörben talál.
...
* [Google Widevine-licenc sablonja](drm-widevine-license-template-concept.md)
...
* [PlayReady-licencsablon](drm-playready-license-template-concept.md)
...
![AES titkosítatlan kulcs](./media/drm-encrypt-content-how-to/aes-clear-key-policy.png)
...
![Egy adatfolyam-kereső](./media/drm-encrypt-content-how-to/multi-drm.png)
...
[Eszközök kezelése](asset-create-asset-upload-portal-quickstart.md)
