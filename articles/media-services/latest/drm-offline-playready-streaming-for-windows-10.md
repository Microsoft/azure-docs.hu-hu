...
- [Offline FairPlay-streamelés iOS-hez](drm-offline-fairplay-for-ios-concept.md)
- [Offline Widevine streaming Android rendszerhez](drm-offline-widevine-for-android.md)
...
## <a name="background-on-offline-mode-playback"></a>Háttér offline üzemmód lejátszásakor
