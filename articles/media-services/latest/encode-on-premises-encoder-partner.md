---
title: Helyszíni kódoló partner lesz
...
2. Hozzon létre és indítsa el az **átmenő** élő eseményt. <br/> További információ: [élő események állapota és számlázása](live-event-states-billing-concept.md).
...
1. A Media Services-fiókjában ellenőrizze, hogy fut-e a **folyamatos átviteli végpont** . 
2. Hozza létre és indítsa el az élő **kódolás** élő eseményét. <br/> További információ: [élő események állapota és számlázása](live-event-states-billing-concept.md).
...
[Tesztelt helyszíni kódolók](encode-recommended-on-premises-live-encoders.md)
