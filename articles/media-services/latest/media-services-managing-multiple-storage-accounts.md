---
title: Media Services v3-eszközök kezelése több Storage-fiókon keresztül | Microsoft Docs
description: Ez a cikk útmutatást nyújt a Media Services v3-eszközök több Storage-fiókban való kezeléséhez.
...
ms.locfileid: "105572429"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>Media Services v3-eszközök kezelése több Storage-fiókon keresztül  
