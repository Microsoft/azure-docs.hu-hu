...
- A v2-es streaming végpont "rendelkezésre állási csoport" tulajdonsága már nem támogatott. A [magas rendelkezésre állású VOD](./architecture-high-availability-encoding-concept.md) -szállításról a V3 API-ban tekintse meg a minta projektet és útmutatást.
