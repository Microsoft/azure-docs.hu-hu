...
1. Válassza a **tovább lehetőséget: hozzáférési házirend >**. Ekkor megjelenik a hozzáférési házirend képernyője.
1. Adja meg a felhasználó számára a Key Vault megfelelő engedélyeit.  Az alapértelmezett engedélyeknek elégnek kell lenniük.
1. Válassza a **Tovább: Hálózatkezelés** lehetőséget. Ekkor megjelenik a hálózatkezelés képernyő.
1. Válassza ki a használni kívánt végpont típusát.
