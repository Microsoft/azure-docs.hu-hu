...
ms.locfileid: "101705472"
---
<!--Create a thumbnail sprites REST-->

A következő Azure REST-parancs egy miniatűr-átalakítót hoz létre. Cserélje le az értékeket `subscriptionID` , a `resourceGroup` és `accountName` a értékeket a jelenleg használatban lévő értékekre. 

Adja meg az átalakítás nevét a beállítás alapján `transformName` .
