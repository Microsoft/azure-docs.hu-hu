...
A következő példában egy kódolót használtak egy köztes eszköz kódolásához hét ISO MP4 (180p és 1080p között). A kódolt eszköz [dinamikusan becsomagolható](encode-dynamic-packaging-concept.md) a következő streaming protokollok bármelyikére: HLS, MPEG Dash és Smooth.
