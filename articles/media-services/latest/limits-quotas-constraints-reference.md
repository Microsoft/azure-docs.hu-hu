...
| --- | --- |
| Egyetlen előfizetésben lévő [fiókok Media Services](account-move-account-how-to.md) | 100 (rögzített) |
...
| Erőforrás | Alapértelmezett korlát | 
| --- | --- | 
| [Feladatok](transform-jobs-concept.md) /Media Services fiók | 500 000 <sup>(3)</sup> (rögzített)|
| Feladathoz tartozó bemenetek száma | 50 (rögzített)|
| Feladatok kimenete/feladatok | 20 (rögzített) |
| [Átalakítások](transform-jobs-concept.md) száma Media Services fiókkal | 100 (rögzített)|
...
| Erőforrás | Alapértelmezett korlát | 
| --- | --- | 
| [Élő események](live-event-outputs-concept.md) <sup>(4)</sup> /Media Services fiók |5|
| Élő kimenet/élő esemény |3 <sup>(5)</sup> |
| Élő kimenet maximális időtartama | [A DVR ablak mérete](live-event-cloud-dvr-time-how-to.md) |

<sup>4</sup> az élő események korlátaival kapcsolatos részletes információkért lásd: [élő eseménytípus összehasonlítása és korlátai](live-event-types-comparison-reference.md).
...
| Erőforrás | Alapértelmezett korlát |
| --- | --- |
| [Adatfolyam-végpontok](stream-streaming-endpoint-concept.md) (leállított vagy futó) Media Services fiókkal | 2 |
| Prémium szintű folyamatos átviteli egységek | 10 |
| [Dinamikusjegyzék-szűrők](filters-dynamic-manifest-concept.md)|100|
| [Folyamatos átviteli házirendek](stream-streaming-policy-concept.md) | 100 <sup>(6)</sup> |
| Egy adott eszközhöz társított egyedi [streaming-lokátorok](stream-streaming-locators-concept.md) | 100<sup>(7)</sup> (rögzített) |
...
| Erőforrás | Alapértelmezett korlát |
| --- | --- |
| A [tartalmi kulcsokra vonatkozó házirend](drm-content-key-policy-concept.md) beállításai |30 |
