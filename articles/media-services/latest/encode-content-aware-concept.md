---
title: A Content-Aware kódoláshoz beállított beállításkészlet
...
![A torzítás (RD) görbéje a PSNR használatával](media/encode-content-aware-concept/msrv1.png)

**1. ábra: a ráta-torzítás (RD) görbe használata a PSNR metrikával a nagy komplexitású forráshoz**

![A torzítás (RD) görbéje a VMAF használatával](media/encode-content-aware-concept/msrv2.png)
...
![Távoli asztali görbe a PSNR használatával](media/encode-content-aware-concept/msrv3.png)

**3. ábra: távoli asztali görbe a PSNR használatával alacsony színvonalú bevitelhez (1080p)**

![Távoli asztali görbe a VMAF használatával](media/encode-content-aware-concept/msrv4.png)
