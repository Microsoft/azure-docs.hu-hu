---
title: Miniatűrök előállítása Media Encoder Standard .NET használatával
...
Azt javasoljuk, hogy ismerkedjen meg az egyéni átalakításokkal, ha beolvassa a [kódolást egy egyéni átalakító-.net](transform-custom-presets-how-to.md)használatával.
