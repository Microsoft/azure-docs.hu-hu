...
- [Hozzon létre egy Media Services fiókot](./account-create-how-to.md). <br/>Ügyeljen rá, hogy jegyezze fel az erőforráscsoport nevét és a Media Services fiók nevét. 
- [A Poster beállítása Azure Media Services REST API-hívásokhoz](setup-postman-rest-how-to.md).<br/>Ügyeljen arra, hogy kövesse az [Azure ad-token beszerzése](setup-postman-rest-how-to.md#get-azure-ad-token)című témakör utolsó lépését. 
