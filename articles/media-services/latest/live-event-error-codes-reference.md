...
ms.locfileid: "106279476"
---
# <a name="media-services-live-event-error-codes"></a>Media Services élő események hibakódja

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

A következő táblázatok az [élő események](live-event-outputs-concept.md) hibakódait tartalmazzák.
...
>|**MPE_CLIENT_TERMINATED_SESSION** ||Igen|
...
[Adatfolyam-végpont (forrás) hibakódok](stream-streaming-endpoint-error-codes-reference.md)
