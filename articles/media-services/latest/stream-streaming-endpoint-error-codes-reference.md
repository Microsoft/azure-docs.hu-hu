...
ms.locfileid: "106282139"
---
# <a name="streaming-endpoint-origin-errors"></a>Streamvégpont (forrás) hibái

Ez a témakör a Azure Media Services [streaming Endpoint szolgáltatástól](stream-streaming-endpoint-concept.md)kapott hibákat ismerteti.
...
- [Koncepció: folyamatos átviteli szabályzatok](stream-streaming-policy-concept.md)
