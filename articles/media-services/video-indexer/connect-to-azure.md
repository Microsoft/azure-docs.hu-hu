...
1. Hívja [a Create-Account fiókot a Media Services és az Azure ad-alkalmazással](https://videoindexer.ai.azure.us/account/login?source=apim).
...
- Az engedélyekkel és erőforrásokkal kapcsolatos összes előzetes követelmény az [Azure-hoz való csatlakozás előfeltételeiben](#prerequisites-for-connecting-to-azure)leírtak szerint. Győződjön meg arról, hogy az [automatikus folyamat további előfeltételeit](#additional-prerequisites-for-automatic-flow) és [a manuális adatforgalomra vonatkozó további](#additional-prerequisites-for-manual-flow)előfeltételeket ellenőrzi.
