...
A [Brand API létrehozása](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Create-Brand) létrehoz egy új egyéni márkát, és hozzáadja azt a megadott fiók egyéni márkák modelljéhez.
...
A [márka törlése](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Delete-Brand) API eltávolítja a megadott fiók egyéni márkák modelljéből származó márkát. A fiók meg van adva a `accountId` paraméterben. A sikeres hívás után a márka már nem *szerepel a* Brands *(márkák)* listában.
...
A [Brand API beolvasása](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Get-Brand) lehetővé teszi, hogy a márka azonosítójának használatával megkeresse az egyéni márkák modellben található márka részleteit.
...
A [Brand API frissítése](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Update-Brand) lehetővé teszi, hogy a márka azonosítójának használatával megkeresse az egyéni márkák modellben található márka részleteit.
...
A [minden márka beolvasása](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Get-Brands) API az egyéni márkák modellben lévő összes márkát visszaadja a megadott fiókhoz, függetlenül attól, hogy a márka a *befoglalási* vagy *kizárási* márkák listájában szerepel-e.
...
A [márkák frissítése](https://api-portal.videoindexer.ai/api-details#api=Operations&operation=Update-Brands-Model-Settings) API frissíti a márkák modell beállításait a megadott fiókban. A márkák modell beállításai azt jelzik, hogy engedélyezve van-e a Bing Brands adatbázisának észlelése. Ha a Bing-márkák nincsenek engedélyezve, a Video Indexer csak a megadott fiók Custom Brands modelljéből származó márkákat fogja felderíteni.
