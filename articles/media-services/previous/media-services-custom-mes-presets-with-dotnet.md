...
- [Kódolás egyéni átalakítással a CLI használatával](../latest/transform-custom-preset-cli-how-to.md)
- [Kódolás a Media Services v3 használatával](../latest/encode-concept.md)
