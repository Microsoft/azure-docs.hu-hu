...
A [SPEECH SDK](../cognitive-services/speech-service/index.yml) gyors útmutatója példákat tartalmaz arra, hogyan használhatja az Azure Kinect DK mikrofon-tömböt különböző programozási nyelveken.
...
* [Windows audio architektúra](/windows-hardware/drivers/audio/windows-audio-architecture)
* [Windows. Media. Capture dokumentáció](/uwp/api/Windows.Media.Capture)
* [Oktatóanyag a webkamera rögzítéséhez](/windows/uwp/audio-video-camera/basic-photo-video-and-audio-capture-with-mediacapture)
* [USB-hanginformációk](/windows-hardware/drivers/audio/usb-2-0-audio-drivers)
