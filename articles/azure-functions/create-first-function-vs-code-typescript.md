...
Ebben a szakaszban a Visual Studio Code használatával hozzon létre egy helyi Azure Functions projektet írógéppel. A cikk későbbi részében közzéteszi a függvény kódját az Azure-ban. 
...
1. Amikor a rendszer kéri, adja meg az alábbi információkat:
    ...
    + **Válasszon nyelvet a függvényprojekthez**: Válassza a `TypeScript` elemet.
