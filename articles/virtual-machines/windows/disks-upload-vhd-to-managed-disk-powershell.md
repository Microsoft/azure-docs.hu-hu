...
- ReadyToUpload, ami azt jelenti, hogy a lemez készen áll a feltöltésre, de nem jött létre [biztonságos hozzáférési aláírás](../../storage/common/storage-sas-overview.md) (SAS).
...
> [!TIP]
> Ha operációsrendszer-lemezt hoz létre, adja hozzá a következőt: `-HyperVGeneration '<yourGeneration>'` `New-AzDiskConfig` .
