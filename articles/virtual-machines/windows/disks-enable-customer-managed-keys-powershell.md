...
### <a name="encrypt-an-existing-virtual-machine-scale-set-with-sse-and-customer-managed-keys"></a>Meglévő virtuálisgép-méretezési csoport titkosítása az SSE és az ügyfél által felügyelt kulcsokkal 

Másolja a szkriptet, cserélje le az összes példát a saját paraméterekre, majd futtassa a parancsot:
