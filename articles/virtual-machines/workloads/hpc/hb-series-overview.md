...
![Az Azure hypervisor és a HB sorozatú virtuális gép számára fenntartott magok elkülönítése](./media/architecture/hb-segregation-cores.png)
