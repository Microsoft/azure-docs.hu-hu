---
title: Azure Policy megfelelőségi vezérlők az Azure Image Builder
description: Felsorolja Azure Policy Azure-beli virtuális szolgáltatásokhoz elérhető szabályozási megfelelőségi Image Builder. Ezek a beépített szabályzatdefiníciók gyakori megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 04/14/2021
ms.topic: sample
author: cynthn
ms.author: cynthn
