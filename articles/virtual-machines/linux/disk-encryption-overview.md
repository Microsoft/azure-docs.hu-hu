...
| RedHat | RHEL 7 – LVM | 7 – LVM | RedHat: RHEL: 7 – LVM: 7.9.2020111202 | Operációs rendszer és az adatlemez (lásd az alábbi megjegyzést) |
| RedHat | RHEL 7,9 | 7_9 | RedHat: RHEL: 7_9: legújabb | Operációs rendszer és az adatlemez (lásd az alábbi megjegyzést) |
...
| OpenLogic | CentOS 7 – LVM | 7 – LVM | OpenLogic: CentOS-LVM: 7-LVM: 7.9.2021020400 | Operációs rendszer és az adatlemez |
| OpenLogic | CentOS 7,9 | 7_9 | OpenLogic: CentOS: 7_9: legújabb | Operációs rendszer és az adatlemez |
| OpenLogic | CentOS 7,8 | 7_8 | OpenLogic: CentOS: 7_8: legújabb | Operációs rendszer és az adatlemez |
