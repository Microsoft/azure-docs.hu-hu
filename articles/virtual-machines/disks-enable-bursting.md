...
Az igény szerinti burst parancsmagok az [Azure CLI-modul](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)2.19.0 és újabb verzióiban érhetők el. Azt is megteheti, hogy használja a [Azure Cloud Shell](https://shell.azure.com/).
