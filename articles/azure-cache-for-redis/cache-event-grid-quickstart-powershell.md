...
New-AzRedisCache
   ...
   [<CommonParameters>]
```
A gyorsítótár-példány PowerShellben való létrehozásával kapcsolatos további információkért tekintse meg a [Azure PowerShell referenciát](https://docs.microsoft.com/powershell/module/az.rediscache/new-azrediscache?view=azps-5.2.0). 
...
Import-AzRedisCache
      ...
      [<CommonParameters>]
```
A PowerShell-beli importálással kapcsolatos további információkért tekintse meg a [Azure PowerShell referenciát](https://docs.microsoft.com/powershell/module/az.rediscache/import-azrediscache?view=azps-5.2.0). 
