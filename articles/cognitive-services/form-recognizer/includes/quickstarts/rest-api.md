...
> [!NOTE]
> A nagy pontosságú modellekhez manuálisan címkézett adatok is betanítható. Tekintse meg a vonatot az első lépések útmutató [címkével](../../quickstarts/label-tool.md) .
