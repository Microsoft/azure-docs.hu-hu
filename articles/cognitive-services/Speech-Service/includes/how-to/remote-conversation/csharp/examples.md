...
ms.locfileid: "106450275"
---
## <a name="upload-the-audio"></a>A hang feltöltése

Az aszinkron átírás első lépése az, hogy elküldje a hangot a beszélgetési átírási szolgáltatásnak a Speech SDK (1.13.0 vagy újabb verzió) használatával.

Ez a példa azt mutatja be, hogyan hozhat létre egy `ConversationTranscriber` csak aszinkron üzemmódot. Ahhoz, hogy hangot lehessen továbbítani az átiratok számára, [a SPEECH SDK-val valós időben](../../../../how-to-use-conversation-transcription.md)bevezeti a hangos adatfolyam-kódot, amely a beszélgetési beszélgetésekből származik. 
