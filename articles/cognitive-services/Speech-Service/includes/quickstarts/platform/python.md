...
- Végül pedig [a Python 3,6 és a 3,9](https://www.python.org/downloads/)között kell lennie. A telepítés ellenőrzéséhez nyisson meg egy parancssort, és írja be a parancsot, `python --version` és vizsgálja meg az eredményt. Ha megfelelően van telepítve, a következőhöz hasonló választ kaphat: "Python 3.8.8".
...
1. Töltse le és telepítse a [Python](https://www.python.org/downloads/) legújabb támogatott verzióját a platformhoz, 3,6 – 3,9.
