...
---
# <a name="tutorial-security-in-azure-sql-managed-instance-using-azure-ad-server-principals-logins"></a>Oktatóanyag: Biztonság az Azure AD kiszolgálói rendszerbiztonsági tagokat (bejelentkezéseket) használó felügyelt SQL-példányban
