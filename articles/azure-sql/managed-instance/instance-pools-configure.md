...
> [!NOTE]
> A készletben található adatbázisok számának korlátozásait, valamint a készlet látogatási [példányának erőforrás-korlátai](instance-pools-overview.md#resource-limitations) szakaszban található felügyelt példányok számát.
