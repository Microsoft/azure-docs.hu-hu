...
További információ a Azure SQL Database ügyfélkapcsolati házirendjéről: Azure SQL Database- [kapcsolatok házirendje](../database/connectivity-architecture.md#connection-policy). 
