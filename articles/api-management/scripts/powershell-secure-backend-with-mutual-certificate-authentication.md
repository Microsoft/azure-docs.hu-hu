...
description: Ismerje meg, hogyan használhatja a Azure PowerShell mintákat a háttérrendszer kölcsönös tanúsítványhitelesítéssel történő biztonságossá történő éhez.
