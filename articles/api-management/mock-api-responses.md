...
1. Az **Előtere ablakban** adja meg a következő értékeket.
    ...
    | **Leírás**     |                                   |  A művelet opcionális leírása, amely az API-t használó fejlesztőknek biztosít dokumentációt a fejlesztői portálon.                                                    |
