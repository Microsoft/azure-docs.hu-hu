...
> [!IMPORTANT]
> Ha a előtti felügyeleti API-verzió használatával importált egy API `2021-01-01-preview` -t, előfordulhat, hogy a `validate-parameters` házirend nem működik. Előfordulhat, hogy újra kell importálnia az API-t a felügyeleti API `2021-01-01-preview` vagy újabb verzió használatával.
