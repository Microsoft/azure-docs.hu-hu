...
| maximális méret | A kérelem vagy válasz törzsének maximális hossza bájtban, a fejlécben bejelölve `Content-Length` . Ha a kérelem törzse vagy a válasz törzse tömörítve van, ez az érték a kibontott hossz. Maximálisan megengedett érték: 102 400 bájt (100 KB).  | Igen       | N/A   |
