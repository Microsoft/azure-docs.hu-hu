...
További információ a Log Analytics adatainak lekérdezéséről: Ismerkedés [a lekérdezésekkel a log Analyticsban](../azure-monitor/log-query/get-started-queries.md). 
