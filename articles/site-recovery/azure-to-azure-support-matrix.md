...
Országonkénti vészhelyreállításra fenntartott korlátozott régiók |Nyugat-Svájc fenntartotta Észak-Svájcot, Dél-Franciaország a közép-Franciaország számára van fenntartva, Egyesült Arab Emírségek északi ügyfelei számára korlátozott Egyesült Arab Emírségek középső régiója, Nyugat-Afrika keleti régiója ügyfelek számára, Jio India középső régiója a JIO Nyugat-India ügyfelei számára, Délkelet-Brazília Dél-Brazília

A különböző kontinenseken található két régió közötti virtuális gépek replikációja és helyreállítása a következő régiópárokra korlátozódik:

* Délkelet-Ázsia és Kelet-Ausztrália
* Délkelet-Ázsia és Délkelet-Ausztrália
* Nyugat-Európa és az USA déli középső régiója.
...
> - Ha a régió, amelyben létre szeretné hozni a tárolót, nem mutatja meg, győződjön meg arról, hogy az előfizetése rendelkezik hozzáféréssel az erőforrások létrehozásához ebben a régióban.
> - Ha a replikáció engedélyezésekor nem látja a földrajzi fürtön belüli régiót, győződjön meg arról, hogy az előfizetése rendelkezik a régióban található virtuális gépek létrehozásához szükséges engedélyekkel.

## <a name="cache-storage"></a>Gyorsítótár

Ez a táblázat összefoglalja a replikáció során a Site Recovery által használt gyorsítótár-tárfiók támogatását.

**Beállítás** | **Támogatás** | **Részletek**
--- | --- | ---
Általános célú V2-tárfiókok (a hot és a cool szint) | Támogatott | A GPv2 használata nem ajánlott, mert a V2 tranzakciós költségei jelentősen magasabbak, mint a V1 tárfiókok.
Prémium szintű Storage | Nem támogatott | A standard szintű tárfiókok a gyorsítótár-tároláshoz használhatók a költségek optimalizálása érdekében.
...
Vegye figyelembe, hogy a fenti korlátok csak az Azure-hoz és az Azure-hoz, valamint a zóna–zóna DR-forgatókönyvekhez vannak megszabadva. 
...
Debian 9.1 | [9.39](https://support.microsoft.com/help/4597409/) | 4.9.0-1-amd64 –4.9.0-14-amd64 </br> 4.19.0-0.bpo.1-amd64 - 4.19.0-0.bpo.12-amd64 </br> 4.19.0-0.bpo.1-cloud-amd64 to 4.19.0-0.bpo.12-cloud-amd64 </br> 4.19.0-0.bpo.13-amd64, 4.19.0-0.bpo.13-cloud-amd64–9.39 gyorsjavítási javítás**</br> 
Debian 9.1 | [9,38](https://support.microsoft.com/help/4590304/) | 4.9.0-1-amd64 –4.9.0-13-amd64 </br> 4.19.0-0.bpo.1-amd64 - 4.19.0-0.bpo.11-amd64 </br> 4.19.0-0.bpo.1-cloud-amd64 - 4.19.0-0.bpo.11-cloud-amd64 </br> 4.9.0-14-amd64, 4.19.0-0.bpo.12-amd64, 4.19.0-0.bpo.12-cloud-amd64-9.38 gyorsjavítási javítás**
...
Adatlemez – prémium szintű tárfiók | Támogatott | Ha egy virtuális gép lemezei prémium és standard szintű tárfiókok között vannak elterjedve, akkor minden lemezhez külön céltárfiókot választhat, hogy ugyanaz a tárolási konfiguráció legyen a célterületen.
...
Kettős titkosítás az adatáttitkosításhoz | Támogatott | További információ a [Windows](../virtual-machines/disk-encryption.md) és Linux támogatott [régióiról](../virtual-machines/disk-encryption.md)
Azure Disk Encryption (ADE) Windows operációs rendszerhez | Felügyelt lemezekkel lévő virtuális gépek esetén támogatott. | A nem támogatott lemezeket használó virtuális gépek nem támogatottak. <br/><br/> A HSM által védett kulcsok nem támogatottak. <br/><br/> Az egyes kötetek egyetlen lemezen való titkosítása nem támogatott. |
...
Azure Storage-tűzfalak virtuális hálózatokhoz  | Támogatott | Ha korlátozza a virtuális hálózatok tárfiókhoz való hozzáférését, engedélyezze [a Megbízható kapcsolatok engedélyezése Microsoft-szolgáltatások.](../storage/common/storage-network-security.md#exceptions)
Általános célú V2-tárfiókok (a hot és a cool szint egyaránt) | Támogatott | A tranzakciós költségek jelentősen növekednek az általános célú V1 tárfiókhoz képest
