...
Ha az elsődleges hely újra működik, az Azure-ból Azure Stackra is visszatérhet. Ehhez kövesse az [itt](/azure-stack/operator/site-recovery-failback)ismertetett lépéseket.
