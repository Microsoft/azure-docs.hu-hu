---
title: Azure Backup Azure-beli virtuális gépek biztonsági SQL Server támogatási mátrixa
description: Összefoglalja az Azure-beli virtuális gépeken SQL Server biztonsági Azure Backup vonatkozó támogatási beállításokat és korlátozásokat.
ms.topic: conceptual
ms.date: 04/07/2021
...
_*Az adatbázis méretkorlátja a támogatott adatátviteli sebességtől és a biztonsági mentés időkorlátjának konfigurációjától függ. Ez nem a nehéz korlát. [További információ a](#backup-throughput-performance) biztonsági mentés átviteli sebességéről._
...
* Ha több biztonsági mentési megoldással készít biztonsági másolatot az önálló SQL Server példányról vagy az SQL Always on rendelkezésre állási csoportról, az biztonsági mentési hibákhoz vezethet. Ezt ne teszi meg. Ha egy rendelkezésre állási csoport két csomópontját egyenként, azonos vagy eltérő megoldásokkal készíti el, az biztonsági mentés sikertelenségéhez is vezethet.
* A rendelkezésre állási csoportok konfigurálásakor néhány tényező alapján a rendszer biztonsági másolatokat készít a különböző csomópontokról. A rendelkezésre állási csoportok biztonsági mentési viselkedését az alábbiakban foglaljuk össze.
