...
A kibontott lemez használatához bontsa ki a mögöttes partíciót. További információ: [lemezpartíció és fájlrendszer kibontása](/azure/virtual-machines/linux/expand-disks#expand-a-disk-partition-and-filesystem).
