---
title: Azure Policy megfelelőség szabályozása az Azure SignalR-hez
description: Felsorolja Azure Policy Azure SignalR-hez elérhető szabályozási megfelelőségi vezérlőket. Ezek a beépített szabályzatdefiníciók gyakori megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 04/21/2021
ms.topic: sample
author: sffamily
ms.author: zhshang
