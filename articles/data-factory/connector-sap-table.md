...
- A Data Factory SAP Table connectorban használt SAP-felhasználónak a következő engedélyekkel kell rendelkeznie:
  ...
  - A S_SDSAUTH engedélyezési objektum végrehajtási tevékenységének engedélyei, vagy a S_RFC végrehajtásához szükséges engedélyek: FUGR-RFC1, SYST, SYSU függvény-RFCPING, RFC_FUNCTION_SEARCH ACTVT – 16 engedélyezési objektum. 
