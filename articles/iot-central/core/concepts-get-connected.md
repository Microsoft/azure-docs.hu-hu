...
Ha az eszközt a DPS-vel szeretné kiépíteni, használja a hatókör-azonosítót, a hitelesítő adatokat és az eszköz AZONOSÍTÓját a IoT Central alkalmazásból. A hitelesítő adatok típusával kapcsolatos további tudnivalókért lásd: [X. 509 csoportos regisztráció](#x509-group-enrollment) és [sas csoportos regisztráció](#sas-group-enrollment). További információ az eszközök azonosítói: [eszköz regisztrálása](#device-registration).
