---
title: Az Azure Batch ügyféloldali kódtár használata a JavaScripthez
description: Megismerheti a Azure Batch alapvető fogalmait, és létrehozhat egy egyszerű megoldást a JavaScript használatával.
ms.topic: how-to
ms.date: 01/01/2021
...
ms.locfileid: "106231419"
---
# <a name="get-started-with-batch-sdk-for-javascript"></a>Ismerkedés a Batch SDK-val a JavaScripthez

Megtudhatja, hogyan hozhat létre egy batch-ügyfelet a JavaScriptben [Azure batch JavaScript SDK](https://github.com/Azure/azure-sdk-for-js/)használatával. Részletesen ismertetjük a Batch-alkalmazások forgatókönyvének megértését, majd a JavaScript használatával beállítjuk azt.

## <a name="prerequisites"></a>Előfeltételek

Ez a cikk azt feltételezi, hogy a JavaScript és a Linux megismerése jól működik. Azt is feltételezi, hogy rendelkezik egy, a Batch- és Storage-szolgáltatások létrehozásához szükséges hozzáférési jogosultságokkal ellátott Azure-fiókkal.
...
Az alábbi ábra azt ábrázolja, hogyan méretezhető a Python-szkript Azure Batch és egy ügyfél használatával.

![A forgatókönyv architektúráját bemutató ábra.](./media/batch-js-get-started/batch-scenario.png)

A JavaScript-minta egy előkészítési feladattal rendelkező batch-feladatot helyez üzembe (részletesen részletezve), valamint a Storage-fiókban lévő tárolók számától függően a feladatok egy készletét. A szkripteket letöltheti a GitHub-adattárból.

- [Példakód](https://github.com/Azure-Samples/azure-batch-samples/blob/master/JavaScript/Node.js/sample.js)
- [Előkészítési tevékenységhez kapcsolódó héjszkriptek](https://github.com/Azure-Samples/azure-batch-samples/blob/master/JavaScript/Node.js/startup_prereq.sh)
- [Python CSV – JSON feldolgozó](https://github.com/Azure-Samples/azure-batch-samples/blob/master/JavaScript/Node.js/processcsv.py)

> [!TIP]
> A megadott hivatkozásban található JavaScript-minta nem tartalmaz az Azure Function alkalmazásként telepítendő kódot. Az alábbi hivatkozások azon útmutatásokra mutatnak, amelyek segítségével létrehozhatja azt.
...
Most végezzük el a JavaScript-ügyfél összeállításának lépéseit:

### <a name="step-1-install-azure-batch-sdk"></a>1. lépés: Az Azure Batch SDK telepítése

A JavaScripthez készült Azure Batch SDK a NPM install paranccsal telepíthető.

`npm install azure-batch`

Ez a parancs az Azure-batch JavaScript SDK legújabb verzióját telepíti.

>[!Tip]
> Egy Azure-függvényalkalmazásban az npm install parancs futtatása az alkalmazás Beállítások lapjának „Kudu konzol” felületéről történik. Ebben az esetben telepítse a JavaScript Azure Batch SDK-t.
...
A következő kódrészlet először importálja az Azure-batch JavaScript-modult, majd létrehoz egy batch szolgáltatás-ügyfelet. Először létre kell hoznia egy SharedKeyCredentials objektumot az előző lépésből átmásolt Batch-fiókkulccsal.
...
Feltöltheti a szkriptet egy Azure Storage-fiókba, és létrehozhat egy SAS URI-t a szkripthez történő hozzáféréshez. Ez a folyamat az Azure Storage JavaScript SDK használatával is automatizálható.
...
A portálon részletesen megtekinthetők a tevékenységek és a feladatok állapotai. Az Azure JavaScript SDK-ban is használhatja a List és a Get függvényeket. Részletes információkat a dokumentáció [hivatkozását](https://azure.github.io/azure-sdk-for-node/azure-batch/latest/Job.html) megnyitva talál.
...
- A Batch API megismeréséhez tekintse meg a [Batch JavaScript-referenciáját](/javascript/api/overview/azure/batch) .