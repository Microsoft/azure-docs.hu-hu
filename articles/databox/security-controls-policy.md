---
title: Azure Policy szabályozási megfelelőségi szabályozása Azure Data Box
description: Felsorolja Azure Policy Azure Data Box számára elérhető szabályozási megfelelőségi szabályozásokat. Ezek a beépített szabályzat-definíciók közös megközelítéseket biztosítanak az Azure-erőforrások megfelelőségének kezeléséhez.
ms.date: 03/24/2021
ms.topic: sample
author: alkohli
ms.author: alkohli
