...
| Régió | Rendelkezésre állás | Zóna – redundáns HA | 
| --- | --- | --- |
...
| Az USA középső régiója | :heavy_check_mark: | :heavy_check_mark: | 
...
| Közép-Kanada | :heavy_check_mark: | :heavy_check_mark: | 
| Közép-Franciaország | :heavy_check_mark: | :heavy_check_mark: | 
