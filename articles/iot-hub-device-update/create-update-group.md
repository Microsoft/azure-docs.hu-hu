...
A feladatokat több eszközön is ütemezheti, [Ha az alábbi példákat](../iot-hub/iot-hub-devguide-jobs.md) követve hozzáad vagy frissít egy eszköz-frissítési címkét. [További információ](../iot-hub/iot-hub-csharp-csharp-schedule-jobs.md).
