---
title: Tárolóba helyezése Java Web Apps-alkalmazásokat és Migrálás az Azure Kubernetes Service-be
description: Ismerje meg, hogyan tárolóba helyezése Java-webalkalmazásokat, és hogyan telepíthet át az Azure Kubernetes szolgáltatásba.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
