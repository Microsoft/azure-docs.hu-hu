...
ms.locfileid: "104778491"
---
# <a name="assessment-overview-migrate-to-azure-vms"></a>Felmérés áttekintése (migrálás Azure-beli virtuális gépre)

Ez a cikk áttekintést nyújt az értékelésekről a [Azure Migrate: Server Discovery and Assessment](migrate-services-overview.md) Tool. Az eszköz képes a helyszíni kiszolgálók kiértékelésére a VMware virtuális és Hyper-V környezetben, valamint fizikai kiszolgálókat az Azure-ba való áttelepítéshez.
