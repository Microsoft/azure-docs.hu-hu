...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Új felhőalapú szolgáltatás létrehozása egyetlen szerepkörrel és tanúsítvánnyal a Key vaultból
