...
Az alábbi példa kiemeli a változóknak a bicep-fájlba való felvételének változásait, amelyek egyedi Storage-fióknevet hoznak létre. Másolja a teljes fájlt, és cserélje le a bicep-fájlt annak tartalmára.
