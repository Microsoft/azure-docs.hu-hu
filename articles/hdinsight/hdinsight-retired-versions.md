---
title: Azure HDInsight-verziók
description: Ismerje meg az Azure HDInsight-ben kivont verziókat.
...
ms.locfileid: "103490245"
---
# <a name="retired-hdinsight-versions"></a>Kivont HDInsight-verziók

Ebből a cikkből megtudhatja, hogyan érhető el a HDInsight-ben a kivont verziók.

## <a name="retired-version-list"></a>Kivont verziók listája

A következő táblázat a HDInsight kivont verzióit sorolja fel.
...
- [A HDInsight által támogatott Apache-összetevők és-verziók](./hdinsight-component-versioning.md)
