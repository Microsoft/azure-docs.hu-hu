...
:::image type="content" source="./media/apache-spark-structured-streaming-overview/hdinsight-spark-structured-streaming.png" alt-text="Stream feldolgozása a HDInsight és a Spark strukturált streaming segítségével" border="false":::
...
:::image type="content" source="./media/apache-spark-structured-streaming-overview/hdinsight-spark-structured-streaming-concept.png" alt-text="Strukturált adatfolyam-koncepció" border="false":::
...
:::image type="content" source="./media/apache-spark-structured-streaming-overview/hdinsight-spark-structured-streaming-append-mode.png" alt-text="Strukturált adatfolyam-hozzáfűzési mód" border="false":::
...
:::image type="content" source="./media/apache-spark-structured-streaming-overview/hdinsight-spark-structured-streaming-complete-mode.png" alt-text="Strukturált folyamatos átvitel teljes módja" border="false":::
...
:::image type="content" source="./media/apache-spark-streaming-overview/hdinsight-spark-streaming-livy.png" alt-text="Spark streaming-alkalmazás üzembe helyezése" border="false":::
