...
A HDInsight Spark-fürtök egy [ODBC-illesztőt](/sql/connect/odbc/download-odbc-driver-for-sql-server?view=sql-server-ver15) biztosítanak a BI-eszközök, például a Microsoft Power bi közötti kapcsolathoz.
