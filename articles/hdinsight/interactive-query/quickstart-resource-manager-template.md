...
1. Adja meg vagy válassza ki a következő értékeket:
    ...
    :::image type="content" source="./media/quickstart-resource-manager-template/resource-manager-template-hive.png" alt-text="Resource Manager-sablon HBase üzembe helyezése" border="true":::
