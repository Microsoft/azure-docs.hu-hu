...
:::image type="content" source="./media/hdinsight-hadoop-customize-cluster-bootstrap/hdinsight-customize-cluster-bootstrap-arm.png" alt-text="A Hadoop testreszabja a fürt rendszerindítási Azure Resource Manager sablonját":::
