...
További információ az Azure AD-token alkalmazáshoz való beszerzéséről: az [elemzési adatok elérése az áruházi szolgáltatásokkal](https://docs.microsoft.com/windows/uwp/monetize/access-analytics-data-using-windows-store-services#step-2-obtain-an-azure-ad-access-token).
