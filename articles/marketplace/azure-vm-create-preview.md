---
title: Előzetes verzió célközönségének hozzáadása virtuálisgép-ajánlathoz az Azure Marketplace-en
description: Megtudhatja, hogyan adhat hozzá előnézeti célközönséget egy virtuálisgép-ajánlathoz az Azure Marketplace-en.
...
Az **előnézet** lapon (válassza ki a partneri központ bal oldali navigációs menüjéből) válassza ki a korlátozott **előzetes verzió célközönségét** az ajánlat érvényesítéséhez, mielőtt közzéteszi azt a szélesebb kereskedelmi Piactéri közönség számára.
