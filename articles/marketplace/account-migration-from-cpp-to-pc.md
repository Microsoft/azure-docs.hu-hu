...
3. Az ajánlatait [megkeresve](https://appsource.microsoft.com/)erősítse meg ajánlatait a AppSource. Ha az ajánlatok már a AppSource-ban vannak, folytassa a következő lépéssel. A AppSource-ben nem szereplő bármely ajánlathoz hozzon létre egy [új dynamics 365 Customer engagement-ajánlatot](.\partner-center-portal\create-new-customer-engagement-offer.md) vagy egy [új Dynamics 365-műveleti ajánlatot](.\partner-center-portal\create-new-operations-offer.md).
