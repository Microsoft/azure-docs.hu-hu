...
- [Az Azure-tevékenység naplójának diagnosztikai beállításainak konfigurálása](/azure/azure-monitor/platform/activity-log)
...
**Útmutató**: az Azure-beli adatmegosztás támogatja az egyszeri bejelentkezéses hitelesítést Azure Active Directory (Azure ad) használatával. Csökkentse a felhasználók által felügyelt identitások és hitelesítő adatok számát, ha engedélyezi az egyszeri bejelentkezést a szolgáltatásnak a szervezete már meglévő identitásával.
...
**Útmutató**: az Azure ad többtényezős hitelesítésének engedélyezése és a Azure Security Center identitás-és hozzáférési javaslatainak követése.
...
- [Az Azure AD többtényezős hitelesítésének engedélyezése](../active-directory/authentication/howto-mfa-getstarted.md)
...
- [Az Azure-adatmegosztás az általános Azure-beli beépített szerepkörökkel működik ](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#general)
