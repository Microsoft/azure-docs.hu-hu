...
* Állapot-lekérdezések (a [PowerShell](/powershell/module/servicefabric/?preserve-view=true&view=azureservicefabricps), a [CLI](service-fabric-sfctl.md), a [C# FabricClient API](/dotnet/api/system.fabric.fabricclient.healthclient) -k és a [Java FabricClient API](/java/api/system.fabric)-k, illetve a [REST API](/rest/api/servicefabric)-k használatával).
