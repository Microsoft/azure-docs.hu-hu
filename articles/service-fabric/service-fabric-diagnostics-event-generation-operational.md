...
**Elhelyezési események**
| Napszállta | Name | Kategória | Leírás |Forrás (feladat) | Level |
| --- | --- | ---| --- | --- | --- |
| 17616 | Döntés |Statetransition sablontípus | Az elhelyezési művelet úgy lett ütemezve, hogy eldöntse az új replikák elhelyezését. | CRM | Tájékoztató |
